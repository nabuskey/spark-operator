...
| prometheus.podMonitor.podMetricsEndpoint | object | `{"interval":"5s","scheme":"http"}` | Promestheus metrics endpoint properties. `metrics.portName` will be used as a port |
